...
public class WorkDairyInputActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        webView.loadUrl("https://project-one.sakura.ne.jp/app/diary.new.php?username="+userName);
    }
